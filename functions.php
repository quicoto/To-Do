...
if ( ! function_exists( 'todo_setup' ) ) :
	...
	function todo_setup() {
		...
		register_nav_menus(
			array(
				'menu-1' => esc_html__( 'Primary', 'todo' ),
			)
		);
...
function todo_scripts() {
	...
	wp_enqueue_style( 'todo-style', get_stylesheet_uri(), array(), _S_VERSION );
	...
	wp_enqueue_script( 'todo-bootstrap', get_template_directory_uri() . '/bootstrap/bootstrap.min.js', array('jquery'), $bootstrap_vesion, true );
	...
	$main_version = "1.0.0";
	wp_enqueue_script('todo-main', get_template_directory_uri() . '/js/main.js', array('jquery'), $main_version, true);
